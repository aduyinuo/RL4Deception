...
class MBPO(RLAlgorithm):
    ...
    def __init__(
        ...
        # Step 1: initialize transition model 
        ...
        # Step 1: initialize environment dataset
        self._pool = pool
        ...
        for self._epoch in gt.timed_for(range(self._epoch, self._n_epochs)):
            ...
            for i in count():
                ...
                if self._timestep % self._model_train_freq == 0 and self._real_ratio < 1.0:
                    ...
                    # Step 3: train transition model on environment dataset
                ...
                # Step 5: take action (sample) with current policy 
            ...
            # Step 10: update policy parameters on model data
