...
class NetworkState():
    def __init__(self, clients):
        self.nodes = { 
                ...
                7: {
                    ...
                    'node_state': 0, # actual state of attacker, 0 - no foothold, 1 - foothold, 2 - priv.esc, 3 - data ex.
    ...
    def observationVector(self):
        ...
        for i, node in enumerate(self.nodes):
            ...
            encoded_state = self.one_hot_encode(state, 4) # 4 possible states for attacker 
    ...
    def translateState(self, state):
        ...
        if state == "exfil":
            ...
            return 0# no attacker activity detected
...
# monitor network when this file is run 
